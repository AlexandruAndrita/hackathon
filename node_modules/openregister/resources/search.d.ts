...
export declare class Search extends APIResource {
     ...
     */
    autocompleteCompaniesV1(query: SearchAutocompleteCompaniesV1Params, options?: RequestOptions): APIPromise<SearchAutocompleteCompaniesV1Response>;
    /**
     ...
     * Search for people
     */
    findPersonV1(body: SearchFindPersonV1Params, options?: RequestOptions): APIPromise<SearchFindPersonV1Response>;
    /**
     * Find company by website URL
     */
    lookupCompanyByURL(query: SearchLookupCompanyByURLParams, options?: RequestOptions): APIPromise<SearchLookupCompanyByURLResponse>;
}
/**
 ...
 */
export type CompanyLegalForm = 'ag' | 'eg' | 'ek' | 'ev' | 'ewiv' | 'foreign' | 'gbr' | 'ggmbh' | 'gmbh' | 'kg' | 'kgaa' | 'unknown' | 'llp' | 'municipal' | 'ohg' | 'se' | 'ug';
/**
...
export declare namespace CompanySearch {
...
export declare namespace SearchAutocompleteCompaniesV1Response {
    interface Result {
        /**
         * Company status - true if active, false if inactive.
         */
...
export declare namespace SearchFindPersonV1Response {
    interface Pagination {
        /**
         * Current page number.
         */
...
export declare namespace SearchFindCompaniesV1Params {
    interface Filter {
...
export declare namespace SearchFindPersonV1Params {
    interface Filter {
