...
export declare class Document extends APIResource {
     ...
     */
    getRealtimeV1(query: DocumentGetRealtimeV1Params, options?: RequestOptions): APIPromise<DocumentGetRealtimeV1Response>;
}
...
export interface DocumentGetRealtimeV1Response {
    category: 'current_printout' | 'chronological_printout' | 'historical_printout' | 'structured_information' | 'shareholder_list' | 'articles_of_association';
...
export interface DocumentGetRealtimeV1Params {
    company_id: string;
    document_category: 'current_printout' | 'chronological_printout' | 'historical_printout' | 'structured_information' | 'shareholder_list' | 'articles_of_association';
}
export declare namespace Document {
    export { type DocumentGetCachedV1Response as DocumentGetCachedV1Response, type DocumentGetRealtimeV1Response as DocumentGetRealtimeV1Response, type DocumentGetRealtimeV1Params as DocumentGetRealtimeV1Params, };
}
