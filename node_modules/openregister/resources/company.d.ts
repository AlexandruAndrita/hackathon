...
export declare class Company extends APIResource {
     ...
     */
    getDetailsV1(companyID: string, query?: CompanyGetDetailsV1Params | null | undefined, options?: RequestOptions): APIPromise<CompanyGetDetailsV1Response>;
    /**
     ...
     * Get company owners
     */
    getOwnersV1(companyID: string, query?: CompanyGetOwnersV1Params | null | undefined, options?: RequestOptions): APIPromise<CompanyGetOwnersV1Response>;
    /**
...
export declare namespace CompanyGetDetailsV1Response {
    /**
     * Contact information of the company.
     */
    interface Contact {
    ...
    interface Representation {
         ...
         */
        role: 'DIRECTOR' | 'PROKURA' | 'SHAREHOLDER' | 'OWNER' | 'PARTNER' | 'PERSONAL_LIABLE_DIRECTOR' | 'LIQUIDATOR' | 'OTHER';
        /**
...
export declare namespace CompanyGetFinancialsV1Response {
    /**
     * All report periods merged into a single view
     */
    interface Merged {
...
export declare namespace CompanyGetHoldingsV1Response {
    interface Holding {
        /**
         * Unique company identifier. Example: DE-HRB-F1103-267645
         */
...
export declare namespace CompanyGetOwnersV1Response {
    interface Owner {
        /**
...
export declare namespace CompanyGetUbosV1Response {
    interface Ubo {
        /**
